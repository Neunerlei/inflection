...
class InflectorTest extends TestCase {
	...
	public function _testSymfonyToSingularProvider() {
		return [
			['accesses', 'access'],
			['addresses', 'address'],
			['agendas', 'agenda'],
	 ...
	 */
	public function testSymfonyToSingular($plural, $expect) {
		$this->assertEquals($expect, Inflector::toSingular($plural));
	}
	
	public function _testSymfonyToPluralDataProvider() {
		return [
			['access', 'accesses'],
			['address', 'addresses'],
			['agenda', 'agendas'],
	 ...
	 */
	public function testSymfonyToPlural($singular, $expect) {
		$this->assertEquals($expect, Inflector::toPlural($singular));
	}
	
	public function _testToSlugDataProvider() {
		return [
	 ...
	 */
	public function testToSlug($a, $b) {
		$this->assertEquals($a, Inflector::toSlug($b));
	}
	
	public function _testToFileDataProvider() {
		return [
	 ...
	 */
	public function testToFile($a, $b, $c = FALSE) {
		$this->assertEquals($a, Inflector::toFile($b, $c));
	}
	
	public function _testToArrayDataProvider() {
		return [
			[["given", "string"], " Given   string   "],
			[["given", "string"], "Given string"],
			[["given", "string", "jpg"], "given-string.jpg"],
	 ...
	 */
	public function testToArray($a, $b, $c = FALSE) {
		$this->assertEquals($a, Inflector::toArray($b, $c));
	}
	
	public function _testToSpacedUpperDataProvider() {
		return [
			["Given String", "Given string"],
			["Given String Jpg", "given-string.jpg"],
			["Given String Jpg", "Given string.jpg"],
	 ...
	 */
	public function testToSpacedUpper($a, $b, $c = FALSE) {
		$this->assertEquals($a, Inflector::toSpacedUpper($b, $c));
		$this->assertEquals($a, Inflector::toHuman($b, $c));
	}
	
	public function _testToCamelCaseDataProvider() {
		return [
	 ...
	 */
	public function testToCamelCase($a, $b, $c = FALSE) {
		$this->assertEquals($a, Inflector::toCamelCase($b, $c));
	}
	
	public function _testToCamelBackDataProvider() {
		return [
			["givenString", "Given string"],
			["givenStringJpg", "given-string.jpg"],
			["givenStringJpg", "Given string.jpg"],
	 ...
	 */
	public function testToCamelBack($a, $b, $c = FALSE) {
		$this->assertEquals($a, Inflector::toCamelBack($b, $c));
	}
	
	public function _testToDashedDataProvider() {
		return [
			["given-string", "Given string"],
			["given-string-jpg", "given-string.jpg"],
			["given-string-jpg", "Given string.jpg"],
	 ...
	 */
	public function testToDashed($a, $b, $c = FALSE) {
		$this->assertEquals($a, Inflector::toDashed($b, $c));
	}
	
	public function _testToUnderscoreDataProvider() {
		return [
	 ...
	 */
	public function testToGetter($a, $b, $c = "get", $d = []) {
		$this->assertEquals($a, Inflector::toGetter($b, $c, $d));
	}
	
	public function _testToSetterDataProvider() {
		return [
	 ...
	 */
	public function testToSetter($a, $b, $c = []) {
		$this->assertEquals($a, Inflector::toSetter($b, $c));
	}
	
	public function _testToPropertyDataProvider() {
		return [
	 ...
	 */
	public function testToProperty($a, $b, $c = []) {
		$this->assertEquals($a, Inflector::toProperty($b, $c));
	}
	
	public function _testToComparableDataProvider() {
		return [
	 ...
	 */
	public function testToComparable($a, $b, $c = TRUE) {
		$this->assertEquals($a, Inflector::toComparable($b, $c));
	}
	
	
	public function _testToUuidDataProvider() {
		return [
	 ...
	 */
	public function testToUuid($a, $b) {
